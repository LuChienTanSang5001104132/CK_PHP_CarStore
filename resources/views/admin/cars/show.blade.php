    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 flex flex-col gap-6">
            ...
            <div class="bg-white rounded-2xl shadow p-4">
                ...
                @else
                    <div class="w-full h-56 bg-gray-100 rounded-xl flex flex-col items-center justify-center text-gray-400">
            ...
            <div class="bg-white rounded-2xl shadow p-4">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">Ảnh Phụ</h3>
                <div class="grid grid-cols-3 gap-2">
                    @foreach($car->images as $image)
                    <img src="{{ asset('storage/' . $image->image_path) }}"
                         alt=""
                         class="w-full h-20 object-cover rounded-lg bg-gray-50">
                    @endforeach
                </div>
            </div>
            @endif
